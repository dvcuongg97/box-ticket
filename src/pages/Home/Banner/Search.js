...
import "../../../asset/Home/Banner/Search.css";
        ...
        <div className="flex justify-around">
          <div className="border-r-2 px-2">
            <select
              ...
              id="countries"
              className="border-none cursor-pointer focus:outline-none  text-sm font-medium p-2.5 focus:rounded-lg"
            >
          ...
          <div className="border-r-2 px-2">
            <select
              ...
              id="countries2"
              className="border-none cursor-pointer focus:outline-none text-gray-900 text-sm font-medium p-2.5 focus:rounded-lg"
            >
          ...
          <div className="border-r-2 px-2">
            <select
              ...
              id="countries"
              className="border-none focus:rounded-lg focus:outline-none cursor-pointer text-gray-900 text-sm font-medium p-2.5 "
            >
